...
def install_dependencies():
    ...
    for dep in dependencies:
        ...
        if result.returncode == 0:
            ...
            print(f"  [FAIL] {dep} 安裝失敗: {result.stderr}")
...
def deploy_all():
    ...
    print("\n[SUCCESS] 所有功能部署完成！")
    print("\n接下來你可以:")
    print("1. 運行: streamlit run conflict_dashboard.py")
    print("2. 查看: SYSTEM_OPTIMIZATION_ROADMAP.md")
    print("3. 測試: python test_conflicts_simple.py")
    print("4. 分析: python analyze_tag_conflicts.py")
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("\n機器學習衝突檢測已就緒")
            print("使用方法: from conflict_learning_system import ConflictLearner")
        elif choice == "3":
            launch_dashboard()
        elif choice == "4":
            print("\n衝突規則分析工具已就緒")
            print("使用方法: python analyze_tag_conflicts.py")
        elif choice == "5":
            print("\n系統性能監控已就緒")
